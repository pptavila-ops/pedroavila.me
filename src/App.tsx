    ...
    return (
        <main className="flex min-h-screen items-center justify-center bg-black text-white px-6 py-12 md:py-24">
            <div className="max-w-xl text-[26px] md:text-[32px] leading-[1.2] text-left font-bold tracking-tight">
                ...
                <div className="flex gap-5 items-center tracking-normal">
                ...
                <div className="grid grid-cols-3 gap-3 mt-4 tracking-normal">
                    ...
                    <Tooltip text="Click to copy">
                        <button onClick={handleCopyEmail} className="grid w-full rounded-md border border-white/20 px-4 py-2 text-sm font-semibold text-white/60 transition-colors hover:border-white/40 hover:text-white cursor-pointer">
                            ...
                            <div key={i}>
                                ...
                                >
                                    ...
                                    <svg
                                        ...
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        className={`text-white/50 shrink-0 ml-3 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
                                    >
                ...
                <div className="flex flex-col gap-2 tracking-normal text-base font-normal">
                    <div className="flex items-center gap-2 overflow-hidden">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 text-white/60">
                    ...
                    <div className="flex items-center gap-2 overflow-hidden">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0 text-white/50">
