...
function App() {
    ...
    return (
        <main className="flex min-h-screen bg-black text-white">
            ...
            {/* Right Panel — Content */}
            <div className="w-full md:ml-[32%] lg:ml-[28%] min-h-screen px-6 py-12 md:py-14 md:px-10 lg:px-14">
                {study ? (
                    <div>
                        <button
                            onClick={closeStudy}
                                ...
                                >
                                    ...
                                    <div className="relative rounded-xl border border-white/10 group-hover:border-white/20 transition-colors overflow-hidden p-5 flex flex-col h-[300px] bg-black z-10">
                                        ...
                                        <div className="relative -mt-1">
                                            <div className="flex items-center gap-2 text-base text-white/50">{cs.year}{cs.id === 'design-transformation' && <span className="text-[9px] font-semibold uppercase tracking-widest text-white/70 border border-white/30 rounded-full px-2 py-0.5">Current Role</span>}</div>
