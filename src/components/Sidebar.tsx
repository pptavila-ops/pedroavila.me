...
const Sidebar: React.FC = () => {
    return (
        <aside style={{
            ...
            {/* Header / Name */}
            <div>
                <h1 className="text-foreground font-bold tracking-tight" style={{ fontSize: 'var(--text-4xl)', lineHeight: '1.1', marginBottom: '1rem' }}>
                    Pedro Ávila
                </h1>
                <p className="text-muted font-medium text-lg leading-relaxed">
                    Currently enabling design teams move from static design artifacts to shipping real product code.
                </p>
            </div>

            {/* Navigation / Links */}
            <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                <p className="text-sm font-bold text-foreground" style={{ opacity: 0.5, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Recent Work</p>
                <a href="#" className="text-foreground font-medium hover:opacity-70 transition-opacity">Designing workflows for safe shipping</a>
